...
public class GetCardInformation {
	...
	public String clxCardInformationAPI(String userId, String accountId) throws JSONException{
		...
		try {
			...
			URL url = new URL("http://35.180.75.185/CreditumDemoAPI/API/Card/Information");
